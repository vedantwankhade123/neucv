...
export const resumeTemplates: Record<string, Template> = {
  ...
  corporate: { name: 'Corporate', component: withWatermark(CorporateTemplate), category: 'Professional', photoRequired: true, isPremium: true },
  executive: { name: 'Executive', component: withWatermark(ExecutiveTemplate), category: 'Professional', photoRequired: false, isPremium: true },
  ...
  greenfield: { name: 'Greenfield', component: withWatermark(GreenfieldTemplate), category: 'Modern', photoRequired: true, isPremium: true },
  'corporate-blue': { name: 'Corporate Blue', component: withWatermark(CorporateBlueTemplate), category: 'Professional', photoRequired: true, isPremium: true },
  ...
  modern: { name: 'Modern', component: withWatermark(ModernTemplate), category: 'Modern', photoRequired: true, isPremium: true },
  ...
  designer: { name: 'Designer', component: withWatermark(DesignerTemplate), category: 'Creative', photoRequired: true, isPremium: true },
  creative: { name: 'Creative', component: withWatermark(CreativeTemplate), category: 'Creative', isPremium: true },
